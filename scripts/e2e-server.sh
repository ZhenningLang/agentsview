...
agent_env=(
  ...
  "KILO_DIR=$EMPTY_DIR"
  "DROID_SESSIONS_DIR=$EMPTY_DIR"
  "OPENCODE_DIR=$EMPTY_DIR"
  "OPENHANDS_CONVERSATIONS_DIR=$EMPTY_DIR"
  "CURSOR_PROJECTS_DIR=$EMPTY_DIR"
  "AMP_DIR=$EMPTY_DIR"
  "ZENCODER_DIR=$EMPTY_DIR"
  "IFLOW_DIR=$EMPTY_DIR"
  "ZED_DIR=$EMPTY_DIR"
  "VSCODE_COPILOT_DIR=$EMPTY_DIR"
  "PI_DIR=$EMPTY_DIR"
  "QWEN_PROJECTS_DIR=$EMPTY_DIR"
  "COMMANDCODE_PROJECTS_DIR=$EMPTY_DIR"
  "OPENCLAW_DIR=$EMPTY_DIR"
  "QCLAW_DIR=$EMPTY_DIR"
  "KIMI_DIR=$EMPTY_DIR"
  "KIMI_CODE_DIR=$EMPTY_DIR"
  "KIRO_SESSIONS_DIR=$EMPTY_DIR"
  "KIRO_IDE_DIR=$EMPTY_DIR"
  "CORTEX_DIR=$EMPTY_DIR"
  "HERMES_SESSIONS_DIR=$EMPTY_DIR"
  "WORKBUDDY_PROJECTS_DIR=$EMPTY_DIR"
  "FORGE_DIR=$EMPTY_DIR"
  "PIEBALD_DIR=$EMPTY_DIR"
  "WARP_DIR=$EMPTY_DIR"
  "POSITRON_DIR=$EMPTY_DIR"
  "ANTIGRAVITY_DIR=$EMPTY_DIR"
  "ANTIGRAVITY_CLI_DIR=$EMPTY_DIR"
)
